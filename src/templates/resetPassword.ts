const resetPasswordTemplate = (token: string) => {
  const html = `
                        ...
                        <tr>
                          <td class="sm-px-24"
                            ...
                            <p style="margin: 0 0 24px;">
                              A request to reset your MOX account password was received.
                              Click the link below to reset your account password.
                            </p>
                            <a href="https://dev.mox.verismart.ai/forgot-password/${token}" class="hover-underline"
                                style="--text-opacity: 1; color: #7367f0;  text-decoration: none; cursor: pointer;">Reset your password</a>
                            ...
                            <p style="margin: 0 0 16px;">
                              ...
                              <a href="mailto:nikhil.upadhyay@verismart.ai" class="hover-underline"
                                style="--text-opacity: 1; color: #7367f0;  text-decoration: none; cursor: pointer;">nikhil.upadhyay@verismart.ai</a>.
                            </p>
                            <p style="margin: 0 0 16px;">Thanks, <br>The MOX Support Team</p>
                          </td>
                        </tr>
                        <tr>
      ...
      `;
  const text = `
          Reset Password, A request to reset your MOX account password was received.
          Click the link below to reset your account password.`;
  return {
    html: html,
    text: text,
