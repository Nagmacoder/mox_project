const verifyEmailTemplate = (otp: string) => {
  const html = `
                      ...
                      <tr>
                        <td class="sm-px-24"
                          ...
                          <p style="margin: 0 0 24px;">
                            A request to create your MOX account was received.
                            Use this link to confirm your account and log in
                          </p>
                          <a href="https://dev.mox.verismart.ai/verify/${otp}" class="hover-underline"
                              style="--text-opacity: 1; color: #7367f0;  text-decoration: none; cursor: pointer;">https://dev.mox.verismart.ai/verify/${otp}</a>
    ...
    `;
  const text = `
        Verify Email, A request to create your MOX account was received.
        Use this link to confirm your account and log in`;
  return {
    html: html,
    text: text,
